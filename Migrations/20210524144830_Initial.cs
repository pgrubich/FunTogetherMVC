    ...
    public partial class Initial : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ActivityFilters", x => new { x.ActivityId, x.FilterId });
                    table.ForeignKey(
                        name: "FK_ActivityFilters_Activities_ActivityId",
                        column: x => x.ActivityId,
                        principalTable: "Activities",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ActivityFilters_Filters_FilterId",
                        column: x => x.FilterId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ActivityFilters_FilterId",
